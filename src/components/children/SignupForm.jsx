                    ...
                    <div className="card-panel" id="signup-form">
                        ...
                        <form action="/register" method="POST" onSubmit={this.handleSignup}>
                           ...
                           <div className="row">
                            ...
                            <div className="row">
                                <div className="col s12">
                                    <button className="btn waves-effect waves-light purple lighten-3 black-text loginButtons" type="submit" value="Submit" name="action">Signup<i className="material-icons right">person_add</i></button>
                                </div>
                            </div>
                        </form>
                    </div>
