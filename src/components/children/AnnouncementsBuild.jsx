        ...
        return (
            <div className="card-panel" id="add-announcment">
                ...
                <form onSubmit={this.addAnnouncements}>
                    ...
                    <div className="row">
                        <div className="col s12">
                            <button className="btn waves-effect waves-light purple lighten-3 black-text loginButtons" type="submit" value="Submit" name="action">Submit<i className="material-icons right">add</i></button>
                        </div>
                    </div>
                </form>
            </div>
